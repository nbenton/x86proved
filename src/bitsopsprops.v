...
Proof. move => e op opI . unfold right_zero.
induction n.
- move => x. apply trivialBits.
- case/tupleP => x xx.
unfold liftBinOp in *.
...
Proof. rewrite fromNat0. apply lift_left_zero. by apply andFb. Qed.

Lemma andB0 n : right_zero #0 (andB (n:=n)).
Proof. rewrite fromNat0. apply lift_right_zero. by apply andbF. Qed.
