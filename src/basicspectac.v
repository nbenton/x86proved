...
Require Import x86proved.x86.reg x86proved.x86.flags (* for EIP *) x86proved.x86.program.
...
Ltac locate_regIsReg regIsReg G :=
  match eval cbv beta iota zeta delta [Reg32_to_Reg GPReg32_to_GPReg GPReg_to_Reg NonSPReg_to_Reg] in G with
    | regIsReg ?x     => constr:(x)
