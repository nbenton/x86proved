...
Require Import x86proved.spred x86proved.septac x86proved.spec x86proved.spectac x86proved.safe x86proved.pointsto x86proved.cursor x86proved.reader x86proved.common_tactics.
...
Section Basic.
  ...
  Proof.
    rewrite /basic. split. 
    specintros => i j. 
    autorewrite with push_at. apply lforallL with i. 
    autorewrite with push_at. apply lforallL with j. 
    autorewrite with push_at. do 2 f_cancel; ssimpl.
    specintros => i j. 
    autorewrite with push_at. apply lforallL with i. 
    autorewrite with push_at. apply lforallL with j. 
    autorewrite with push_at. do 2 f_cancel; ssimpl. 
