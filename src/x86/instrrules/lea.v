...
Global Instance: forall (offset : DWORD) (r : GPReg32) (r1 : NonSPReg32) sc,
                   instrrule (instr.LEA _ r (RegMemM _ _ (mkMemSpec _ None (Some(mkSIB _ r (Some(r1, sc)))) offset))) | 0
...
Global Instance: forall (offset : DWORD) (r r' : GPReg32) (r1 : NonSPReg32) sc,
                   instrrule (instr.LEA _ r (RegMemM _ _ (mkMemSpec _ None (Some(mkSIB _ r' (Some(r1, sc)))) offset))) | 1
