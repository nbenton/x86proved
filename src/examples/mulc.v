...
(* lsb is 1 *)
  ...
  rewrite -mulnDl.
  rewrite -ODD. rewrite !muln2. rewrite -> (odd_double_half m).
  rewrite -!muln2. ssimpl. by rewrite mulnA.
...
Proof.
  ...
  autorewrite with push_at.
  do_basic' => //.
    by ssimpl; rewrite expn0 muln1 toNatK.
Qed.
