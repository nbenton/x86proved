...
Notation "'let!' ( x , y , z ) = c ; d" :=
  ...
  (at level 200, x ident, y ident, z ident, c at level 150, d at level 200).

Notation "'let!' ( x , y , z , w ) = c ; d" :=
  (bind c (fun z => match z with ( x , y , z, w ) => d end))
  (at level 200, x ident, y ident, z ident, w ident, c at level 150, d at level 200).
